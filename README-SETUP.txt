TBOP v3 - MOBILE-FIRST PUBLIC SITE + OFFICER DESK
...
SETUP ORDER
1. In Supabase SQL Editor, run supabase-setup-v3.sql.
2. In Supabase Authentication -> Users, create your first officer/admin user with EMAIL + PASSWORD.
3. Copy that user's UUID. At the bottom of supabase-setup-v3.sql, copy the FIRST ADMIN BOOTSTRAP insert, replace UUID-BELOW, and run it.
